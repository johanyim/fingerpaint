...
mod tests {
    ...
    fn removes_colors() {
        let mut testpal = Palette::new("testpal");
        let _ = testpal.add('w', "grey", color::Format::HEXA, "rgba(128,128,128,0.01)"); 
        ...
        assert_eq!(testpal.get_name('w'), "Unassigned");        
    ...
    fn colors_are_not_borrowed() {
        let mut testpal = Palette::new("testpal");
        let _ = testpal.add('q', "blue", color::Format::HEX, "rgb(0,0,255)"); 
    ...
    fn adding_invalid_color() {
        ...
        let mut testpal = Palette::new("testpal");
        testpal.add('q', "an invalid color", 
                            color::Format::RGBA, 
                            &invalid_color);
        ...
        assert_eq!(testpal.get_name('q'), "Unassigned");
    ...
    fn changes_output_format() {
        let mut testpal = Palette::new("testpal");
        testpal.add('q', "transparent yellow", 
                            color::Format::HEX, 
                            "#ffff0080");
